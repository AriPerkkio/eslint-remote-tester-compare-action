...
describe('run-tester', () => {
    ...
    test('runs eslint-remote-tester with internal configuration', async () => {
        await runTester(EXISTING_CONFIG, {}, true);
    ...
    test('throws if given configuration does not exist', () => {
        return expect(() =>
            runTester('./non-existing-config', {}, true)
    ...
    test('merges configuration from comment with internal values', async () => {
        await runTester(
            EXISTING_CONFIG,
            { rulesUnderTesting: ['my-rule'], extensions: ['.mjs'] },
            true
        );
    ...
    test('uses onComplete from users configuration', async () => {
        await runTester(EXISTING_CONFIG_WITH_ON_COMPLETE, {}, true);
    ...
    test('onComplete does not write results on first run', async () => {
        await runTester(EXISTING_CONFIG_WITH_ON_COMPLETE, {}, false);
    ...
    test('configuration is validated', () => {
        ...
        return expect(() =>
            runTester(EXISTING_CONFIG, { repositories: [] }, true)
        )
